...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Hide floating button while inside Hero section (top 450px)
  ...
  return (
    <>
      <a
        ...
        aria-label="Falar pelo WhatsApp com a Barbearia do Nenzinho"
        title="Falar pelo WhatsApp com a Barbearia do Nenzinho"
        style={{
          position: "fixed",
          bottom: "24px",
          right: "24px",
